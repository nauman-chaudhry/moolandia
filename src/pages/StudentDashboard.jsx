              ...
              >
                <span
                  style={{
                    fontSize: "0.95rem",
                    fontWeight: "bold",
                    color: task.category === "Academic" ? "#1976d2" : task.category === "Behavior" ? "#7b1fa2" : "#388e3c",
                    backgroundColor: task.category === "Academic" ? "#e3f2fd" : task.category === "Behavior" ? "#f3e5f5" : "#e8f5e9",
                    borderRadius: "4px",
                    padding: "2px 8px",
